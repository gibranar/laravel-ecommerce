...
<body>
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="{{ route('users.store') }}" method="POST">
                                        @csrf
    ...
    <script>
        const pass = document.getElementById('form3Example4c');
        const repass = document.getElementById('form3Example4cd');
        const warning = document.getElementById('warningMessage');

        repass.addEventListener('input', function() {
            if (pass.value !== repass.value) {
                warning.textContent = 'Password harus sama';
            } else {
                warning.textContent = '';
            }
        });
